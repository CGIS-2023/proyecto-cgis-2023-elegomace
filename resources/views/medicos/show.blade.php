                ...
                <div class="p-6 bg-white border-b border-gray-200">
                        ...
                        <x-auth-validation-errors class="mb-4" :errors="$errors" />
                            ...
                            <div class="mt-4">
                                ...
                                <x-input readonly disabled id="telefono" class="block mt-1 w-full" min="0" step="1" type="number" name="telefono" :value="$medico->telefono" required />
                            </div>

                            <div class="mt-4">
                                <x-label for="num_licenciado" :value="__('Nº de licenciado')" />

                                <x-input readonly disabled id="num_licenciado" class="block mt-1 w-full" min="0" step="1" type="number" name="num_licenciado" :value="$medico->num_licenciado" required />
                            </div>
